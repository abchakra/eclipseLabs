...
import com.jointlogic.breadcrumbs.sampleapp.Activator;
...
class BreadcrumbItemDropDown implements IBreadcrumbDropDownSite {
	 ...
	 */
	private static boolean DEBUG = Activator.DEBUG
			&& "true".equalsIgnoreCase(Platform.getDebugOption("com.jointlogic.breadcrumbs.sampleapp/debug/breadcrumb")); //$NON-NLS-1$//$NON-NLS-2$
	...
	private IDialogSettings getDialogSettings() {
		final IDialogSettings javaSettings = Activator.getDefault()
				.getDialogSettings();
